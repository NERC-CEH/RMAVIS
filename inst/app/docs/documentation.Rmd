...
Version 1.2.2 of `RMAVIS` currently uses version 20250703a of the UKSI to form the GB-NVC taxonomic backbone,
...
RMAVIS v1.2.2 adopts the approach outlined in @reeve2016 as implemented in the R
package `rdiversity`.
