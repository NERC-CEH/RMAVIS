...
-   **Year**: The year the releve was surveyed.
-   **Group**: The group to which the releve belongs.
-   **Releve.Number**: A unique identifier for the releve.
-   **Phys.Code**: A physiognomic stratum code. See @minnesotadepartmentofnaturalresources2013.
-   **Min.Ht**: The minimum height of the taxon for the physiognomic stratum.
-   **Max.Ht**: The maximum height of the taxon for the physiognomic stratum.
-   **Taxon**: Taxon names.
-   **Cover**: Cover values.
...
quadrats by Year, or all quadrats per group by year) and one subcommunity partitions
