...
-   **St. Croix State Forest**:
    Vegetation plot data from a deer exclosure experiment in a Mesic Oak Forest within St Croix State Forest [@berger2019].
    
-   **Earthworm-Invaded Forests**
    Vegetation plot data from .... [@graham2021, @graham2021a]
