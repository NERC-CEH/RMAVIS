  ...
  shiny::fluidRow(
    shiny::column(
      ...
      shiny::div(
        ...
        <summary><b>2025-12-XX</b></summary>
        
        </details>
        <details>

        <summary><b>2025-09-11</b></summary>
        The latest versions of RMAVIS (the v1.1.X series) contain a number of breaking changes relative to the v1.0.1 release.
