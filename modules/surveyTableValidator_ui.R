        ...
        shiny::div(
          ...
          bslib::layout_columns(
            ...
            bslib::popover(
              ...
              shiny::markdown(
                "
                If TRUE all of the required validation conditions are met and MAVIS is ok to proceed with the analysis. The 'Run Analysis' button is enabled.
                
                If FALSE one or more of the required validation conditions are not met and MAVIS is not ok to proceed with the analysis. The 'Run Analysis' button is disabled.
