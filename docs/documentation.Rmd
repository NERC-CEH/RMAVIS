...
Until these conditions are met RMAVIS will not be able to proceed with as
...
Marshall, Z., Smart, S., and Harrower, C.. (2024). RMAVIS.

```         
@misc{marshall2024,
  author = {Marshall, Z. and Smart, S. and Harrower, C.},
  title = {RMAVIS},
  howpublished = {Available at https://connect-apps.ceh.ac.uk/RMAVIS/, version 0.99},
  month = {03},
  year  = {2024},
