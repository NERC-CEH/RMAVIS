...
**Authors**: Zeke Marshall (zekmar@ceh.ac.uk) & Amy Kendig (amy.kendig@state.mn.us).
...
vegetation plot sample data to vegetation classification systems, with additional exploratory analyses.
At present `RMAVIS` supports two vegetation classifications: 
...
tool for the ecology and conservation community. We also welcome feedback, suggestions for new features, and requests to incorporate additional vegetation classification systems!
...
If you wish to use the VC-matching functions outside of the `RMAVIS` app, 
...
## Acknowledgements
The initial development of `RMAVIS` was partly supported by the
UK‐SCAPE delivering National Capability (NE/R016429/1) programme.
The integration of the MNNPC into RMAVIS was partly supported by the
UKCEH National Capability for UK Challenges (NE/Y006208/1)
programme funded by the Natural Environment Research Council (Zeke Marshall)
and the Minnesota Environment and Natural Resources Trust Fund as recommended by the 
Legislative-Citizen Commission on Minnesota Resources (LCCMR) (Amy Kendig).
