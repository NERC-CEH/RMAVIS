...
# dcaSubsetNVCResults
dcaSubsetNVCResults <- params$dcaSubsetNVCResults
# selected_pquads_dca_results_species_final <- dcaSubsetNVCResults$selected_pquads_dca_results_species
# selected_pquads_dca_results_quadrats_final <- dcaSubsetNVCResults$selected_pquads_dca_results_quadrats_final
surveyTable_dca_results_quadrats <- dcaSubsetNVCResults$surveyTable_dca_results_quadrats
selected_pquads_dca_results_quadrats_final_hull <- dcaSubsetNVCResults$selected_pquads_dca_results_quadrats_final_hull
arrow_plot_data <- dcaSubsetNVCResults$arrow_plot_data
CCA_arrowData <- dcaSubsetNVCResults$CCA_arrowData
...
```{r dcaSubsetNVC, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}

dcaSubsetNVCPlot <- ggplot2::ggplot() +
