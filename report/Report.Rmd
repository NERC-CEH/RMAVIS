...
```{r MAVISVersion, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
...
# Introduction
This report contains user-selected outputs of a MAVIS application session.
...
kableExtra::kbl(x = selectedOutputs, format = "latex", booktabs = TRUE,
                ...
                caption = "The MAVIS results selected for inclusion in this report.") |>
...
As detailed in the survey data validation section of MAVIS a sample size 
...
However, at present MAVIS does not prevent analysis if the number
