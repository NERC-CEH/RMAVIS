...
surveyTable_dca_results_quadrats_final <- dcaFixedSpaceResults$surveyTable_dca_results_quadrats_final
...
method1DCAPlot_plot <- ggplot2::ggplot() +
  ...
  #                                            x = DCA1,
  #                                            y = DCA2)) +
  ggplot2::geom_point(data = surveyTable_dca_results_quadrats_final,
                      mapping = ggplot2::aes(color = NVC.Comm,
                                             Quadrat = Quadrat,
                                             x = DCA1,
                                             y = DCA2)) +
