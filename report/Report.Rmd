...
cat("**Version:** ", as.character("v0.96"), sep = "")
...
```{r selectedExampleData, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
if(inputMethod == "example"){
  
  cat("**Selected Example Data:** ", as.character(selectedExampleData), sep = "")
  
  }
```

```{r includeBryophytes, echo=FALSE, message=FALSE, warning=FALSE, results='asis'}
cat("**Bryophytes Included:** ", as.character(includeBryophytes), sep = "")
```
...
As detailed in the survey data validation section of MAVIS
